...
const HomePage = () => {
  return (
    <>
      <Metadata
        title="Portofolio"
        description="Website Portofolio Created By NextJS dan TailwindCSS"
            ...
            <div className="w-full self-center px-4 lg:w-1/2">
              <h1 className="text-base font-semibold text-primary md:text-xl">
                ...
                <span className="mt-1 block text-3xl font-bold text-dark dark:text-white lg:text-5xl">
                  Muhammad Zulki Akbari. People just call me Zul.
                </span>
              </h1>
              ...
              <p className="mb-10 font-medium leading-relaxed text-accents-300 dark:text-white/80">
                &quot;<i>I think ahead, predict challenges before they happen, and always see things from different perspectives.</i>&ldquo;{" "}
